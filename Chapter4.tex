...
Also for the speed values of the rollator route various methods are explored to find the most realistic method. The values are given over a distance of 5 meter. 
...
\centering
\caption{Change point segments for the MeetRollator route\label{routeR}}
\end{figure} 
...
The next two figures show the change points detected for average height, average speed, average slope, and variance of the total acceleration. The change points are located through linking its time stamp with the time of the GPS data. 
...
The right square shows a street with speed bumps that have to be crossed with the bike as well. The slope change points, indicate roughly these bumps, though they do not show in any other parameter. 

\begin{figure}[ht]
\includegraphics[width=\textwidth]{img/R_CP_bike.pdf}
\centering
