...
The urban environment will never be optimal and certain changepoints will indicate not so important happenings. 
...
%The role and impact of changepoint detection?
...
% to map more determinants from the scheme of bartolomew. And compare how these influence eachothre. Environment and personal determinants. see figure \ref{bartolomew}
...
Possible applications of smart phone with accelerometer use, for measuring rollator movements or surface resistance. Translate this to the amount of energy that elderly consume. Wattage of elderly people. %link to above 
...
\item A final but essential recommendation is, detecting wrongly parked bikes and cars. % HOW?
...
%link to the 4 issues at the beginning of your thesis. 
